        ...
        public static void DisconnectClient(ClientStructure client, string reason = "")
        {
            ...
            if (client.ConnectionStatus != ConnectionStatus.Disconnected)
            {
                ...
                if (client.Authenticated)
                {
                    ...
                    // Clear the vessel-sync version cache so this player gets a full
                    // vessel sync on their next connection.
                    VesselMsgReader.ClearClientSyncCache(client.PlayerName);
                }
