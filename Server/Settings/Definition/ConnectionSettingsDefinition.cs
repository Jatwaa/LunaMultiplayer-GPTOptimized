...
namespace Server.Settings.Definition
{
    ...
    public class ConnectionSettingsDefinition
    {
        ...
        [XmlComment(Value = "Try to expand MTU size. Recommended: true. Allows Lidgren to negotiate larger packets with each peer, " +
                            "reducing fragmentation on vessel proto/sync messages.")]
