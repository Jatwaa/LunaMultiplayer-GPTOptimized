...
namespace Server.Settings.Definition
{
    ...
    public class IntervalSettingsDefinition
    {
        ...
        public int VesselUpdatesMsInterval { get; set; } = 30;
        ...
        [XmlComment(Value = "Interval to force a garbage collection and reduce the memory usage. Specify this value in minutes. 0 = deactivated (recommended — let the runtime manage GC).")]
        public int GcMinutesInterval { get; set; } = 0;
    }
}
