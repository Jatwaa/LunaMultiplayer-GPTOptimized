...
namespace LmpClient.Systems.VesselUpdateSys
{
    ...
    public class VesselUpdateSystem : MessageSystem<VesselUpdateSystem, VesselUpdateMessageSender, VesselUpdateMessageHandler>
    {
        ...
        /// <summary>
        /// Removes a vessel from the system and clears its delta-suppression snapshot.
        /// </summary>
        public void RemoveVessel(Guid vesselId)
        {
            VesselUpdates.TryRemove(vesselId, out _);
            VesselUpdateMessageSender.RemoveVessel(vesselId);
        }
