...
#if DEBUG
        private static readonly string Title = $"LMP {LmpVersioning.CurrentVersion} - PID: {CommonUtil.ProcessId}";
#else
        private static readonly string Title = $"LMP {LmpVersioning.CurrentVersion}";
#endif
