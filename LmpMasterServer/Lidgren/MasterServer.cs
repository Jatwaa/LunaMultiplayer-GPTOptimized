...
namespace LmpMasterServer.Lidgren
{
    ...
    {
        var servers = ServerDictionary.Values;
        int count = 0;
        ...
        foreach (var server in servers)
        {
            ...
            count++;
            // Bundle packets: Flush every 10 servers to prevent overwhelming the network buffer 
            // and slightly reduce the immediate amplification peak.
            if (count % 10 == 0)
            {
                peer.FlushSendQueue();
            }
