...
// Type: LmpClient.Systems.VesselUndockSys.VesselUndock
  ...
  public class VesselUndock
  {
    ...
    public void ProcessUndock()
    {
      ...
      if (protoPart == null || !Object.op_Implicit((Object) protoPart.partRef))
        return;
      LmpClient.Base.System<VesselUndockSystem>.Singleton.ManuallyUndockingVesselId = protoPart.partRef.vessel.id;
      LmpClient.Base.System<VesselUndockSystem>.Singleton.IgnoreEvents = true;
      protoPart.partRef.Undock(this.DockedInfo);
      ...
      LmpClient.Base.System<VesselUndockSystem>.Singleton.IgnoreEvents = false;
      LmpClient.Base.System<VesselUndockSystem>.Singleton.ManuallyUndockingVesselId = Guid.Empty;
    }
  }
}
