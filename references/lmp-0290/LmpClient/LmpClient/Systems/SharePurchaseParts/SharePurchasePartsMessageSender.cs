...
// Type: LmpClient.Systems.SharePurchaseParts.SharePurchasePartsMessageSender
...
namespace LmpClient.Systems.SharePurchaseParts
{
  public class SharePurchasePartsMessageSender : SubSystem<SharePurchasePartsSystem>, IMessageSender
  {
    ...
    {
      ShareProgressPartPurchaseMsgData newMessageData = NetworkMain.CliMsgFactory.CreateNewMessageData<ShareProgressPartPurchaseMsgData>();
      newMessageData.PartName = partName;
      newMessageData.TechId = techId;
