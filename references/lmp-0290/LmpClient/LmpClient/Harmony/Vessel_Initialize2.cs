...
// Type: LmpClient.Harmony.Vessel_Initialize2
...
namespace LmpClient.Harmony
{
  ...
  [HarmonyPatch(new Type[] {typeof (bool), typeof (bool), typeof (bool), typeof (bool)})]
  public class Vessel_Initialize2
  {
    [HarmonyPrefix]
    private static void PrefixInitialize(
      Vessel __instance,
    ...
    [HarmonyPostfix]
    private static void PostfixInitialize(
      Vessel __instance,
      bool fromShipAssembly,
      bool preCreate,
      bool orbiting,
