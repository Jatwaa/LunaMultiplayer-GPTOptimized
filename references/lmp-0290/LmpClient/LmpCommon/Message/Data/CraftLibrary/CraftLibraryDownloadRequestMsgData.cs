...
// Type: LmpCommon.Message.Data.CraftLibrary.CraftLibraryDownloadRequestMsgData
...
namespace LmpCommon.Message.Data.CraftLibrary
{
  public class CraftLibraryDownloadRequestMsgData : CraftLibraryBaseMsgData
  {
    ...
    internal override void InternalSerialize(NetOutgoingMessage lidgrenMsg)
    {
      ...
      this.CraftRequested.Serialize(lidgrenMsg);
    }

    internal override void InternalDeserialize(NetIncomingMessage lidgrenMsg)
    {
      base.InternalDeserialize(lidgrenMsg);
      this.CraftRequested.Deserialize(lidgrenMsg);
    }

    internal override int InternalGetMessageSize() => base.InternalGetMessageSize() + this.CraftRequested.GetByteCount();
  }
}
