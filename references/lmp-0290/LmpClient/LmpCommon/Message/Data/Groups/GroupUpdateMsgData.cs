...
// Type: LmpCommon.Message.Data.Groups.GroupUpdateMsgData
...
namespace LmpCommon.Message.Data.Groups
{
  public class GroupUpdateMsgData : GroupBaseMsgData
  {
    ...
    internal override void InternalSerialize(NetOutgoingMessage lidgrenMsg)
    {
      ...
      this.Group.Serialize(lidgrenMsg);
    }

    internal override void InternalDeserialize(NetIncomingMessage lidgrenMsg)
    {
      base.InternalDeserialize(lidgrenMsg);
      this.Group.Deserialize(lidgrenMsg);
    }

    internal override int InternalGetMessageSize() => base.InternalGetMessageSize() + this.Group.GetByteCount();
  }
}
