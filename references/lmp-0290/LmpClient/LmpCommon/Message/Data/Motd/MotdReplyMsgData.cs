...
// Type: LmpCommon.Message.Data.Motd.MotdReplyMsgData
...
namespace LmpCommon.Message.Data.Motd
{
  public class MotdReplyMsgData : MotdBaseMsgData
  {
    ...
    internal override void InternalSerialize(NetOutgoingMessage lidgrenMsg)
    {
      ...
      lidgrenMsg.Write(this.MessageOfTheDay);
    }

    internal override void InternalDeserialize(NetIncomingMessage lidgrenMsg)
    {
      base.InternalDeserialize(lidgrenMsg);
      this.MessageOfTheDay = lidgrenMsg.ReadString();
    }

    internal override int InternalGetMessageSize() => base.InternalGetMessageSize() + this.MessageOfTheDay.GetByteCount();
  }
}
