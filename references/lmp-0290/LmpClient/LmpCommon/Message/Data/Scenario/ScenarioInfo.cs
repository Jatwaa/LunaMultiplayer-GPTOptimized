...
// Type: LmpCommon.Message.Data.Scenario.ScenarioInfo
...
namespace LmpCommon.Message.Data.Scenario
{
  public class ScenarioInfo
  {
    ...
    {
      this.Module = lidgrenMsg.ReadString();
    ...
    public int GetByteCount() => this.Module.GetByteCount() + 4 + this.NumBytes;
  }
}
