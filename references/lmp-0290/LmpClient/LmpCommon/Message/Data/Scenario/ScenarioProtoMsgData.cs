...
// Type: LmpCommon.Message.Data.Scenario.ScenarioProtoMsgData
...
namespace LmpCommon.Message.Data.Scenario
{
  public class ScenarioProtoMsgData : ScenarioBaseMsgData
  {
    ...
    internal override void InternalSerialize(NetOutgoingMessage lidgrenMsg)
    {
      ...
      this.ScenarioData.Serialize(lidgrenMsg);
    }

    internal override void InternalDeserialize(NetIncomingMessage lidgrenMsg)
    {
      base.InternalDeserialize(lidgrenMsg);
      this.ScenarioData.Deserialize(lidgrenMsg);
    }

    internal override int InternalGetMessageSize() => base.InternalGetMessageSize() + this.ScenarioData.GetByteCount();
  }
}
