...
// Type: LmpCommon.Message.Data.ShareProgress.ShareProgressStrategyMsgData
...
namespace LmpCommon.Message.Data.ShareProgress
{
  public class ShareProgressStrategyMsgData : ShareProgressBaseMsgData
  {
    ...
    internal override void InternalSerialize(NetOutgoingMessage lidgrenMsg)
    {
      ...
      this.Strategy.Serialize(lidgrenMsg);
    }

    internal override void InternalDeserialize(NetIncomingMessage lidgrenMsg)
    {
      base.InternalDeserialize(lidgrenMsg);
      this.Strategy.Deserialize(lidgrenMsg);
    }

    internal override int InternalGetMessageSize() => base.InternalGetMessageSize() + this.Strategy.GetByteCount();
  }
}
