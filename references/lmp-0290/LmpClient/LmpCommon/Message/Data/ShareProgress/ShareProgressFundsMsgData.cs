...
// Type: LmpCommon.Message.Data.ShareProgress.ShareProgressFundsMsgData
...
namespace LmpCommon.Message.Data.ShareProgress
{
  public class ShareProgressFundsMsgData : ShareProgressBaseMsgData
  {
    ...
    internal override void InternalDeserialize(NetIncomingMessage lidgrenMsg)
    {
      ...
      this.Funds = lidgrenMsg.ReadDouble();
      this.Reason = lidgrenMsg.ReadString();
    }

    internal override int InternalGetMessageSize() => base.InternalGetMessageSize() + 8;
  }
}
