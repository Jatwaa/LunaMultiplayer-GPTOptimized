...
// Type: LmpCommon.ModFile.Structure.ModControlStructure
...
namespace LmpCommon.ModFile.Structure
{
  public class ModControlStructure
  {
    ...
    public void SetDefaultAllowedParts() => this.AllowedParts = new List<string>()
    {
      "StandardCtrlSrf",
      "CanardController",
      "noseCone",
    ...
    public void SetDefaultAllowedResources() => this.AllowedResources = new List<string>()
    {
      "LiquidFuel",
      "Oxidizer",
      "SolidFuel",
